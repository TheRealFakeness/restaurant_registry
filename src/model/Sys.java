...
public class Sys {
	...
	/**
	 * Adds an order with the given attributes to the object orders. ID is not
	 * autogenerated. <br>
	 * <b>pre:</b> productsIds and productAmount must have the same size.<br>
	 * <b>post:</b> The order will be added to the object orders <br>
	 * @throws IOException 
	 ...
	 */
	public void exportOrders(char separator) throws FileNotFoundException, InterruptedException{
	 ...
	 * <b>pre:</b> Data must have the right format:
	 * nit;name;adminName<br>
	 * <b>pre:</b><br>
